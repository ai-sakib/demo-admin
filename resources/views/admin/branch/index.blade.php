...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Branches &nbsp;<a onclick="addPage('branches','Branch')" class="btn btn-sm bg-success"><i class="fas fa-plus"></i> Add</a></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr id="tr-{{$value->id}}">
                    ...
                    <td>
                      <a onclick="editPage('branches','{{ $value->id }}','User')"  title="Edit" class="btn bg-primary btn-xs"><i class="fas fa-edit" aria-hidden="true"></i></a>
